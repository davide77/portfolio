...
For web components, always prefer the utility classes and SCSS tokens already defined - do not hard-code hex values in new components. See [CLAUDE.md](../../../CLAUDE.md) "Utility classes over component SCSS".
